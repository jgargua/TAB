...
```{r answerP1.1}
readDepth <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/sorted.depth.txt.gz", sep='\t', header=FALSE)
colnames(readDepth) <- c("chr", "position", "depth")
...
```{r ST}
st <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/ST.txt", sep='\t', header=FALSE)
...
```{r answerP1.5}
indel <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/indel.txt", sep='\t', header=FALSE)
head(indel)
...
```{r pi}
pi <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/out.windowed.pi", sep='\t', header=TRUE)
...
```{r answerP1.7}
snpden <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/out.snpden", sep='\t', header=TRUE)
head(snpden)
...
```{r answerP1.8}
vepfile <- read.table("C:/Users/Judit/Desktop/TAB FINAL/P2/njPt2e5kmFLz7fLX.txt", sep='\t', header=TRUE)
head(vepfile)
