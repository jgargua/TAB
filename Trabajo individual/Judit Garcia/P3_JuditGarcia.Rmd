...
obesity.plink <-  read.plink(bed = "/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.bed",
                             bim = "/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.bim",
                             fam = "/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.fam")
```
...
```{r obesity}
obesity.phenotype <- read.delim("/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.txt")
...
```{r transform-data}
snpgdsBED2GDS("/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.bed",
              "/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.fam",
              "/home/samba/homes/1421491/Descargas/Project3/data/obesity/obesity.bim",
              out="obesityGDS"
              )
```
...
# Plot and axis titles
 ...
 manhattanPlot <- manhattanPlot + labs(title = "Obesity GWAS", x = "Chromosome", y = "p-value (-log10(P))")
 manhattanPlot
...
# Add any function to customize your plot
 manhattanPlot <- manhattanPlot + theme_minimal()  + theme(legend.position="none")
 manhattanPlot
```
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
Not all of them, but some of them (for example, rs6931936) are. rs12201995 isn't overlapping, but it's right next to a gene.
</div>
...
<div style="background-color:#F0F0F0">
##### &emsp;<i class="fas fa-comment-dots"></i> Answer:
Before jumping directly into molecular studies, we should to a bibliographic research with these SNPs. We could find information on the localization of this SNP, if it affects a gene and what does this gene do, if the SNP is annotated, etc. 

Once we've found enough information to know a little more about these SNPs, we can choose which ones we think are interesting enough to study through molecular studies.
</div>
